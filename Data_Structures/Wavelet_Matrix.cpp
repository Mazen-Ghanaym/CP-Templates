...
struct bit_vector
{
    ...
    __attribute__((target("popcnt"), optimize("O3,unroll-loops"))) void build()
    {
    ...
    __attribute__((target("bmi2,popcnt"), optimize("O3,unroll-loops"))) inline u32 rank1(u32 i) const
    {
...
struct WaveletMatrix
{
    ...
    {
        auto it = lower_bound(ps.begin(), ps.end(), make_pair(x, S()), [](const P &a, const P &b)
